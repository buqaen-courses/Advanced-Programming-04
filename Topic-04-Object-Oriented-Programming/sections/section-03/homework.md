...
```
┌────────────────────────────────────────────────────────────────────┐
│ Category         │ Feature              │ Methods / Properties      │
├────────────────────────────────────────────────────────────────────┤
│ Magic Methods    │ Sequence protocol    │ __len__, __getitem__      │
│ (SmartList)      │                      │ __setitem__, __delitem__  │
│                  │                      │ __iter__, __reversed__    │
│                  │                      │ __contains__, __eq__      │
│                  │                      │ __add__, __mul__          │
│                  │                      │ __str__, __repr__         │
├──────────────────┼──────────────────────┼──────────────────────────┤
│ Properties       │ Metadata             │ size (ro), capacity       │
│                  │                      │ is_empty (ro), is_full    │
│                  │ Configuration        │ allow_duplicates          │
│                  │                      │ auto_sort, sort_key       │
│                  │                      │ max_item_size             │
├──────────────────┼──────────────────────┼──────────────────────────┤
│ Class Methods    │ Alternative ctors    │ from_iterable(iterable)   │
│                  │                      │ from_csv(file)            │
│                  │                      │ from_json(file)           │
│                  │                      │ repeat(value, n)          │
├──────────────────┼──────────────────────┼──────────────────────────┤
│ Static Methods   │ Utilities            │ validate_item(item)       │
│                  │                      │ merge(*lists)             │
│                  │                      │ find_common(*lists)       │
│                  │                      │ remove_duplicates(items)  │
├──────────────────┼──────────────────────┼──────────────────────────┤
│ Dataclasses      │ Supporting structs   │ OperationRecord          │
│                  │                      │ ContainerStats           │
└────────────────────────────────────────────────────────────────────┘
```
