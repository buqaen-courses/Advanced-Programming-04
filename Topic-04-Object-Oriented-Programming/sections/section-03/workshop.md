...
│  │ transaction_type: str, transaction_id: Optional[int]  │  │
│  │ __post_init__ → validates data                        │  │
│  │ __str__ → "+$50.00 Deposit"                           │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  BankAccount (magic methods + properties + classmethods)    │
│  ┌──────────────────────────────────────────────────────┐  │
│  │ __str__, __repr__, __eq__, __lt__, __add__            │  │
│  │ __len__, __getitem__, __iter__, __bool__              │  │
│  │ @property: owner_name, account_number, balance        │  │
│  │ @classmethod: from_dict(), get_all_accounts()        │  │
│  │ @staticmethod: validate_amount(), format_currency()  │  │
│  └──────────────────────────────────────────────────────┘  │
│                                                             │
│  Bank (collection management)                               │
│  ┌──────────────────────────────────────────────────────┐  │
│  │ open_account(), close_account(), get_account()       │  │
│  │ transfer_between_accounts(), get_bank_summary()      │  │
│  │ __len__(), __iter__()                                │  │
│  └──────────────────────────────────────────────────────┘  │
└────────────────────────────────────────────────────────────┘
```
